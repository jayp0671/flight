...
const PASSAGES = [
  ...
  'The best adventures are the ones where you do not just discover new places, but discover more reasons to fall for the person beside you.',
  ...
  'Life is not about waiting for the perfect moment; it is about packing your bag, booking the ticket, and showing up for the people you love.',
  'We speak in glances, in inside jokes, in little texts that say “I thought of you today” without actually needing to say it.',
  'There is something magical about counting down to a moment you know will change everything — like the first hug after too long apart.',
  'Sometimes the best part of traveling is not the destination or the scenery, but knowing that someone is waiting for you on the other side.',
  ...
  'Love is not just grand gestures and dramatic speeches; it is the everyday choosing, the remembering, and the showing up.',
  ...
  'I cannot wait to see the way your face lights up when you finally spot me in the crowd at the arrivals gate.',
  'Our story is not just about distance and travel; it is about how two people decided that love was worth every timezone, every mile, and every second apart.',
  'Typing fast is easy, but keeping up with how fast you have stolen my heart is impossible.',
  'One day soon, we will not need to count the days, because there will be no more flights to take or goodbyes to say.',
